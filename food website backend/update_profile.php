...
if(isset($_POST['submit'])){
   ...
   // Only process password if old_pass is not empty
...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <!-- Name Field -->
      <input type="text" name="name" placeholder="<?= isset($fetch_profile['name']) ? $fetch_profile['name'] : 'enter your name'; ?>" class="box" maxlength="50">
      
      <!-- Email Field -->
      <input type="email" name="email" placeholder="<?= isset($fetch_profile['email']) ? $fetch_profile['email'] : 'enter your email'; ?>" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      
      <!-- Phone Field -->
      <input type="number" name="number" placeholder="<?= isset($fetch_profile['number']) ? $fetch_profile['number'] : 'enter your phone'; ?>" class="box" min="0" max="9999999999" maxlength="10">
