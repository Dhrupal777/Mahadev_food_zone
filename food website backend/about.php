   ...
   <section class="steps">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <h3>choose order</h3>
            <p>designed with a user-friendly interface that provides a clear, step-by-step process for selecting and
               customizing orders.</p>
         </div>

         <div class="box">
            <img src="images/step-2.png" alt="">
            <h3>fast delivery</h3>
            <p>Our delivery partners are always close by to ensure your food arrives as quickly as possible.</p>
         </div>

         <div class="box">
            <img src="images/step-3.png" alt="">
            <h3>enjoy food</h3>
            <p>Your favorite meals delivered with a smile.</p>
         </div>
